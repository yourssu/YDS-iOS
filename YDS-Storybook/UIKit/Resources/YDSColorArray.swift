...
struct YDSUIKitColorWrapper {
    ...
    static let backgroundColors = WrappedUIKitColors(
        items: [
    ...
    static let textColors = WrappedUIKitColors(
        items: [
    ...
    static let dimColors = WrappedUIKitColors(
        items: [
    ...
    static let borderColors = WrappedUIKitColors(
        items: [
    ...
    static let buttonColors = WrappedUIKitColors(
        items: [
    ...
    static let bottomBarColors = WrappedUIKitColors(
        items: [
    ...
    static let inputFieldColors = WrappedUIKitColors(
        items: [
    ...
    static let toastColors = WrappedUIKitColors(
        items: [
    ...
    static let tooltipColors = WrappedUIKitColors(
        items: [
    ...
    static let pickerColors = WrappedUIKitColors(
        items: [
    ...
    static let pressedColors = WrappedUIKitColors(
        items: [
    ...
    static let shadowColors = WrappedUIKitColors(
        items: [
    ...
    static let monoItemColors = WrappedUIKitColors(
        items: [
    ...
    static let greenItemColors = WrappedUIKitColors(
        items: [
    ...
    static let emeraldItemColors = WrappedUIKitColors(
        items: [
    ...
    static let aquaItemColors = WrappedUIKitColors(
        items: [
    ...
    static let blueItemColors = WrappedUIKitColors(
        items: [
    ...
    static let indigoItemColors = WrappedUIKitColors(
        items: [
    ...
    static let violetItemColors = WrappedUIKitColors(
        items: [
    ...
    static let purpleItemColors = WrappedUIKitColors(
        items: [
    ...
    static let pinkItemColors = WrappedUIKitColors(
        items: [
