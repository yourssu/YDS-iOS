...
class BottomBarControllerPageViewController: YDSBottomBarController {
    ...
    let page2: UIViewController = {
        ...
        viewController.tabBarItem = UITabBarItem(title: nil,
                                                 image: YDSIcon.boardLine,
                                                 selectedImage: YDSIcon.boardFilled)
        return viewController
    }()
    ...
    let page3: UIViewController = {
        ...
        viewController.tabBarItem = UITabBarItem(title: nil,
                                                 image: YDSIcon.timecalendarLine,
                                                 selectedImage: YDSIcon.timecalendarFilled)
        return viewController
    }()
    ...
    let page5: UIViewController = {
        ...
        viewController.tabBarItem = UITabBarItem(title: nil,
                                                 image: YDSIcon.personLine,
                                                 selectedImage: YDSIcon.personFilled)
        return viewController
    }()
