...
class StoryBookViewController: UIViewController {
    ...
    private func setAutolayout() {
        sampleView.snp.makeConstraints {
            ...
            $0.height.equalTo(YDSScreenSize.width * 3/4)
        }
    ...
    //  Optional Image
    public func addOption(description: String?,
                          images: [UIImage?],
                          defaultImage: UIImage?,
                          task: @escaping (UIImage?) -> Void) {
    ...
    //  Enum
    public func addOption<T>(description: String?,
    ...
    //  공통
    private func setControllerView<T> (_ controllerView: ControllerView<T>,
                                       defaultValue: T,
                                       task: @escaping (T) -> Void) {
